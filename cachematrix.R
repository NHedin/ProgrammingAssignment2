...
## Using this function will save time when working with large quntities of data 
...
## The funciton will retrieve the inverse from the cache if it is already calculated
